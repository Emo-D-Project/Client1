              ...
              itemBuilder: (BuildContext context, int index) {
                return Container(
                  ...
                  child: MyCustomContent(
                      ctitle: title[index],
                      cemotions: emotioncount,
                      cmostEmo: mostemo[index],
                      cworstEmo: worstemo[index],
                      cmyMonth: mymonth[index],
                      ctotalEmo: total[index],
                  )
                );
              },
...
class MonthlyData {
    ...
    final double totalEmo;

  MonthlyData({
    required this.title,
    required this.emotions,
    required this.mostEmo,
    required this.worstEmo,
    required this.myMonth,
    required this.totalEmo,
  });
}
