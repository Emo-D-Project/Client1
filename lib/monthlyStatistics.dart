...
final List<double> emotioncount1 = [10, 5, 2, 8, 1, 0, 2];
final List<double> emotioncount2 = [0, 5, 2, 8, 2, 0, 2];
final List<double> emotioncount3 = [0, 10, 2, 1, 1, 3, 2];
...
class _monthlyStatisticsState extends State<monthlyStatistics> {
  ...
  final List<Widget> widgetList = [hello, hi, bye];
