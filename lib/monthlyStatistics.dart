  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("EMO:D",style: TextStyle(fontSize: 30, fontFamily: 'kim',color: Color(0xFF968C83),),),
        leading: IconButton(
          onPressed: () {
            Navigator.push(
        ...
        itemBuilder: (BuildContext context, int index){
          return Container(
            ...
            child: Scrollbar(
              ...
              child: ExpansionTile(
                title: Text(datas[index].title, style: TextStyle(fontFamily: "soojin", fontSize: 25,color: Color(0xFF968C83),),),
                                ...
                                child: SizedBox(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Column(
                                        children: [
                                          Padding(padding: EdgeInsets.fromLTRB(130, 7, 0, 0)),
                                          Container(
                                            height: 120,
                                            width: 130,
                                            ...
                                            child: Column(
                                              children: [
                                                Text('가장 많았던 감정', style: TextStyle(fontFamily: 'soojin', fontSize: 16),),
                                                Image.asset('images/emotion/2.gif', width: 90, height: 90,),
                                              ],
                                            ),
                                          ),
                                          Container(
                                            ...
                                            child: Column(
                                              children: [
                                                Text('가장 많았던 감정', style: TextStyle(fontFamily: 'soojin', fontSize: 16),),
                                                Image.asset('images/emotion/5.gif', width: 90, height: 90,),
                                              ],
                                            ),),
                                        ],
                                      ),
