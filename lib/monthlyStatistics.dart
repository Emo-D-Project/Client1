...
final List<double> emotioncount = [10, 5, 2, 8, 1, 0, 2];
final List<double> emotioncount2 = [0, 10, 3, 2, 9, 0, 0];

class MyCustomContent extends StatefulWidget {
  @override
  _MyCustomContentState createState() => _MyCustomContentState();
}

class _MyCustomContentState extends State<MyCustomContent> {
@override
